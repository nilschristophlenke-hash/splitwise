...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'header.recentlyDeleted': 'Recently deleted',
      ...
      'group.exportBeforeDelete': 'Download a copy first',
      'group.invite': 'Invite',
      ...
      'expense.historyAria': 'View history',
      'expense.notInvolved': 'Not involved',
      'expense.notInvolvedHint': 'This expense only splits between people who were already in the group when it was added — anyone who joined later is not part of it.',
      ...
      'recentlyDeleted.title': 'Recently deleted',
      'recentlyDeleted.hint': 'Deleted expenses stay here for a while, in case you want them back.',
      'recentlyDeleted.emptyTitle': 'Nothing here',
      'recentlyDeleted.emptyBody': 'Deleted expenses will show up here so you can restore them.',

      // ---- expense history modal ----
      'history.title': 'Expense history',
      'history.emptyTitle': 'No history yet',
      'history.emptyBody': 'Changes to this expense will show up here.',

      // ---- group members modal ----
      'members.title': 'Group members',
      'members.emptyTitle': 'No members yet',
      'members.joinedOn': 'Joined {date}',
      'members.methodCreated': 'Created the group',
      'members.methodJoinedCode': 'Joined with a code',

      // ---- demo data migration modal ----
      'migrate.title': 'Bring your demo data along?',
      'migrate.body': 'You have {groups} {groupWord} and {expenses} {expenseWord} saved in this browser from demo mode. Copy them into your new account, or start fresh and leave this demo data here.',
      'migrate.startFresh': 'Start fresh',
      'migrate.confirm': 'Copy it into my account',
      ...
      'settle.toLabel': 'To',
      'settle.methodLabel': 'How did you pay?',
      'settle.method.unspecified': 'Not specified',
      'settle.method.cash': 'Cash',
      'settle.method.bankTransfer': 'Bank transfer',
      'settle.method.paypal': 'PayPal',
      'settle.method.revolut': 'Revolut',
      'settle.method.other': 'Other',
      ...
      'sync.queuedChanges': '{count} changes waiting to sync',
      ...
      'migrate.done': 'Copied {groups} group(s) and {expenses} expense(s) into your account.',
      'toast.exported': 'Copy downloaded',
      'toast.exportFailed': 'Could not download a copy.',
      'toast.restored': 'Restored',
      'toast.restoreFailed': 'Could not restore that one.',
      'err.exactSum': 'The exact amounts have to add up to the total.',
      'err.percentSum': 'The percentages have to add up to 100.',
      'err.sharesPositive': 'Every share has to be a positive number.',
      'err.duplicateParticipant': 'Each person can only be listed once.',
      'err.needParticipant': 'Pick at least one person to split this with.',
      'err.payerNotMember': 'Whoever paid has to be in this group.',
      'err.participantNotMember': 'Everyone splitting this has to be in the group.',
      'err.badInviteCode': 'No group found for that invite code.',
      'err.editConflict': 'Somebody else changed this expense while you were editing it. Reload and try again.',
      'err.expenseGone': 'That expense no longer exists.',
      'err.ownerOnlyDelete': 'Only the group owner can delete this group.',
      'err.ownerOnlyRotate': 'Only the group owner can change the invite code.',
      'err.ownerOnlyTransfer': 'Only the current owner can hand the group over.',
      'err.memberInExpense': 'This person appears in an expense. Settle up and remove their expenses first.',
      'err.ownerCannotLeave': 'You own this group. Hand it over to someone else, or delete it.',
      'err.notAMember': 'You are not a member of this group.',
      'err.groupLimit': 'You have reached the limit of 50 groups.',
      'err.descriptionRequired': 'Give the expense a description.',
      'err.amountPositive': 'The amount has to be greater than zero.',
      'err.network': 'No connection. Your change is saved here and will sync when you are back online.',
      'auth.forgot': 'Forgot your password?',
      'auth.sendResetLink': 'Send reset link',
      'auth.backToSignIn': 'Back to sign in',
      'auth.resetSent': 'If that address has an account, a reset link is on its way. Check your spam folder, delivery can be slow.',
    ...
    de: {
      ...
      'header.recentlyDeleted': 'Kürzlich gelöscht',
      ...
      'group.exportBeforeDelete': 'Vorher eine Kopie herunterladen',
      ...
      'expense.historyAria': 'Verlauf ansehen',
      'expense.notInvolved': 'Nicht beteiligt',
      'expense.notInvolvedHint': 'Diese Ausgabe wird nur zwischen Personen aufgeteilt, die schon in der Gruppe waren, als sie hinzugefügt wurde — wer später beigetreten ist, ist nicht beteiligt.',
      ...
      // ---- recently deleted modal ----
      'recentlyDeleted.title': 'Kürzlich gelöscht',
      'recentlyDeleted.hint': 'Gelöschte Ausgaben bleiben hier eine Weile, falls du sie zurückholen möchtest.',
      'recentlyDeleted.emptyTitle': 'Hier ist nichts',
      'recentlyDeleted.emptyBody': 'Gelöschte Ausgaben tauchen hier auf, damit du sie wiederherstellen kannst.',

      // ---- expense history modal ----
      'history.title': 'Verlauf der Ausgabe',
      'history.emptyTitle': 'Noch kein Verlauf',
      'history.emptyBody': 'Änderungen an dieser Ausgabe tauchen hier auf.',

      // ---- group members modal ----
      'members.title': 'Gruppenmitglieder',
      'members.emptyTitle': 'Noch keine Mitglieder',
      'members.joinedOn': 'Beigetreten am {date}',
      'members.methodCreated': 'Hat die Gruppe erstellt',
      'members.methodJoinedCode': 'Ist mit einem Code beigetreten',

      // ---- demo data migration modal ----
      'migrate.title': 'Deine Demodaten mitnehmen?',
      'migrate.body': 'Du hast {groups} {groupWord} und {expenses} {expenseWord} aus dem Demomodus in diesem Browser gespeichert. Übernimm sie in dein neues Konto, oder fang neu an und lass diese Demodaten hier.',
      'migrate.startFresh': 'Neu anfangen',
      'migrate.confirm': 'In mein Konto übernehmen',
      ...
      'settle.toLabel': 'An',
      'settle.methodLabel': 'Wie wurde bezahlt?',
      'settle.method.unspecified': 'Nicht angegeben',
      'settle.method.cash': 'Bar',
      'settle.method.bankTransfer': 'Banküberweisung',
      'settle.method.paypal': 'PayPal',
      'settle.method.revolut': 'Revolut',
      'settle.method.other': 'Sonstiges',
      ...
      'sync.queuedChanges': '{count} Änderungen warten auf Synchronisierung',
      ...
      'migrate.done': '{groups} Gruppe(n) und {expenses} Ausgabe(n) in dein Konto kopiert.',
      'toast.exported': 'Kopie heruntergeladen',
      'toast.exportFailed': 'Die Kopie konnte nicht heruntergeladen werden.',
      'toast.restored': 'Wiederhergestellt',
      'toast.restoreFailed': 'Das konnte nicht wiederhergestellt werden.',
      'err.exactSum': 'Die genauen Beträge müssen zusammen den Gesamtbetrag ergeben.',
      'err.percentSum': 'Die Prozentwerte müssen zusammen 100 ergeben.',
      'err.sharesPositive': 'Jeder Anteil muss eine positive Zahl sein.',
      'err.duplicateParticipant': 'Jede Person darf nur einmal aufgeführt sein.',
      'err.needParticipant': 'Wähle mindestens eine Person aus, mit der du das aufteilst.',
      'err.payerNotMember': 'Wer bezahlt hat, muss in dieser Gruppe sein.',
      'err.participantNotMember': 'Alle Beteiligten müssen in der Gruppe sein.',
      'err.badInviteCode': 'Zu diesem Einladungscode gibt es keine Gruppe.',
      'err.editConflict': 'Jemand anderes hat diese Ausgabe geändert, während du sie bearbeitet hast. Lade neu und versuche es noch einmal.',
      'err.expenseGone': 'Diese Ausgabe gibt es nicht mehr.',
      'err.ownerOnlyDelete': 'Nur wer die Gruppe angelegt hat, kann sie löschen.',
      'err.ownerOnlyRotate': 'Nur wer die Gruppe angelegt hat, kann den Einladungscode ändern.',
      'err.ownerOnlyTransfer': 'Nur die aktuelle Inhaberin oder der aktuelle Inhaber kann die Gruppe übergeben.',
      'err.memberInExpense': 'Diese Person kommt in einer Ausgabe vor. Gleicht zuerst aus und entfernt ihre Ausgaben.',
      'err.ownerCannotLeave': 'Dir gehört diese Gruppe. Übergib sie an jemand anderen oder lösche sie.',
      'err.notAMember': 'Du bist kein Mitglied dieser Gruppe.',
      'err.groupLimit': 'Du hast das Limit von 50 Gruppen erreicht.',
      'err.descriptionRequired': 'Gib der Ausgabe eine Beschreibung.',
      'err.amountPositive': 'Der Betrag muss größer als null sein.',
      'err.network': 'Keine Verbindung. Deine Änderung ist hier gespeichert und wird synchronisiert, sobald du wieder online bist.',
      'auth.forgot': 'Passwort vergessen?',
      'auth.sendResetLink': 'Link zum Zurücksetzen senden',
      'auth.backToSignIn': 'Zurück zur Anmeldung',
      'auth.resetSent': 'Falls es zu dieser Adresse ein Konto gibt, ist ein Link zum Zurücksetzen unterwegs. Schau auch im Spam-Ordner nach, die Zustellung kann dauern.',
